                        ...
                        <table class="table table-striped mt-4">
                            ...
                            @foreach($permissions as $permissions)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a class="mr-3 btn btn-sm btn-outline-success" href="{{ route('permission.edit', ['permission' => $permissions->id]) }}">Editar</a>
                                        
                                        <form action="{{route('permission.destroy', ['permission' => $permissions->id])}}" method="post">
                                            @csrf
                                            @method('delete')
