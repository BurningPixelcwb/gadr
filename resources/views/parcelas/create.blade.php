        ...
        <form method="post" enctype="multipart/form-data" action="{{ route('eventos.store') }}">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id="validationTextarea" name="desc_evento" placeholder="Descrição do evento" ></textarea>
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="data_ida_evento" class="form-control datepicker" id="data_ida_evento">
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="local_ida_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="data_retorno_evento" class="form-control datepicker" id="exampleFormControlInput1" >
                    </div>
                </div>
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" class="form-control time" name="hora_retorno_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="local_retorno_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="data_inscricao_open" class="form-control datepicker" id="exampleFormControlInput1" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-3">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="data_inscricao_close" class="form-control datepicker" id="exampleFormControlInput1" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="idade_minima_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="total_vagas_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                </div>
                ...
                <div class="form-group col-md-2">
                    ...
                    <div class="input-group mb-2">
                        ...
                        <input type="text" name="minimo_vagas_evento" class="form-control" id="exampleFormControlInput1" >
                    </div>
                </div>
            </div>
